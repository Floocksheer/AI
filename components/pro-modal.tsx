"use client";
import {ImageIcon,Music, MessageSquare, VideoIcon, Code, Check, Zap } from "lucide-react";
            ...
            <Dialog open={proModal.isOpen} onOpenChange={proModal.onClose}>
              <DialogContent>
                 <DialogHeader>
                    ...
                    <DialogDescription className="text-center pt-2 space-y-2 text-zinc-900 fpnt-medium">
                        {tools.map((tool) => (
